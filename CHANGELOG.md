...
- 🛠️ Добавлена библиотека **CodeMirror** для создания редактора кода прямо в браузере.

### 🐞 Исправления и улучшения

- ✅ Исправлено: устранена проблема с `range.surroundContents`, которая вызывала ошибки в некоторых браузерах. Логика изменения цвета текста была переписана для кроссбраузерной совместимости.
- ✅ Улучшено: переработан механизм создания блока кода. В текущей версии поддерживается только код на **JavaScript**.
...
- ✅ Исправлено: при добавлении блока кода теперь автоматически создаётся новое поле ввода
- ✅ Исправлено: поля ввода без текста теперь автоматически удаляются
- ✅ Исправлено: методы больше не вызываются для удалённых полей (раньше продолжали работать после автоудаления)
